...
public class UcOrgInfo implements java.io.Serializable {
	...
	@Size(max=128,message="{ucOrgInfo.length.error}")
    private String merchantSecure;
	...
	public UcOrgInfo(Long orgId, String orgCode, String orgName,
			...
			Long updateUserId, String memo, String merchantNcode,String merchantSecure) {
		this.orgId = orgId;
		this.orgCode = orgCode;
		this.orgName = orgName;
		...
		this.merchantSecure = merchantSecure;
	}
	...
	public String getMerchantSecure() {
		return merchantSecure;
	}

	public void setMerchantSecure(String merchantSecure) {
		this.merchantSecure = merchantSecure;
	}
