...
/**
 * 预存申请表 ClassName: SacChargeApply <br/>
...
public class SacChargeApply implements Serializable
{
    ...
    {
	return "B2bChargeApplyDomain [" + "chargeApplyId=" + chargeApplyId + "applyOrgId=" + applyOrgId + "applyDbtCode=" + applyDbtCode + "applyOrgName=" + applyOrgName + "applyCode=" + applyCode + "payCurrency=" + payCurrency + "payAmount=" + payAmount + "applyDate=" + applyDate + "expiredDate="
		+ expiredDate + "craccNo=" + craccNo + "craccName=" + craccName + "craccNodeCode=" + craccNodeCode + "craccBankName=" + craccBankName + "applyState=" + applyState + "checkedSerialNo=" + checkedSerialNo + "createTime=" + createTime + "lastUpdateTime=" + lastUpdateTime + "applyMemo="
		+ applyMemo + "]";
    }
