...
@Entity
@Table(name = "FIN_STAT_ORG", schema = "SAC_SYN")
public class FinStatOrg implements java.io.Serializable {
	...
	public FinStatOrg(Long statBankId, String codeId, BigDecimal openBal,
