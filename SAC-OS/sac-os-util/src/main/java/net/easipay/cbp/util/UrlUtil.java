...
public abstract class UrlUtil {
	...
	public static void test1() {
		String s = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
				+ "  <bocb2e version=\"110\" locale=\"zh_CN\">" + "  <head>"
				+ "   <termid>E124074246244</termid>"
				+ "   <trnid>04051003129</trnid>"
				+ "   <custid>25378061</custid>"
				+ "   <cusopr>25959684</cusopr>"
				+ "   <trncod>b2e0001</trncod>" + " </head>" + "  <trans>"
				+ "  <trn-b2e0001-rq>" + " <b2e0001-rq>"
				+ " <custdt>20130918013013</custdt>"
				+ "   <oprpwd>mYmt7dsM</oprpwd>" + "</b2e0001-rq>"
	...
	public static void test2() {
		String s = "{\"trxCode\":\"3304\",\"reqTime\":\"20150402121212\",\"otrxCode\":\"\",\"merchantNcode\":\"KJT0001\",\"orgId\":\"1234567891234567893\",\"reqSender\":\"KJT0001\",\"identifyType\":\"30\",\"identifyCode\":\"430111197806070417\",\"userId\":\"7894561231234567897\",\"payAmount\":\"3214.01\",\"payCurrency\":\"CNY\",\"billNo\":\"3333366665555\",\"billSerialNo\":\"B2015040913353065500000000\",\"exchangeInfo\":\"10^USD|15^USD\",\"tradeType\":\"110\",\"txuse\":\"购买基金\"}";
		System.out.println(s);
		String urlStr = "http://localhost:80/trx/ctransaction";
		Map<String, String> requestMap = new HashMap<String, String>();
		requestMap.put("content", s);
		String result = methodPost(urlStr, requestMap);
