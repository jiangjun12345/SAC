...
<script type="text/javascript">
	$(function(){
		...
		$("#download").click(function(){
			$("#preparedFundDetailForm").attr("action","${ctx}/preparedFundRealTimeDetailDownload").submit();
			$("#preparedFundDetailForm").attr("action","${ctx}/preparedFundRealTimeDetailQuery");
		});
		$("#back").click(function(){
			$("#preparedFundRealTimeQueryBackForm").submit();
		});
	});
</script>
<title>备付金余额明细查询</title>
</head>

<body>
	<div style="display: none;">
		<form id="preparedFundRealTimeQueryBackForm" action="preparedFundRealTimeQueryBack" method="get">
			<input type="text" id="chnNo" name="chnNo" value="${sessionScope.chnNo}"/>
			<input type="text" id="chnName" name="chnName"  value="${sessionScope.chnName}"/>
	...
	<div class="content">
	 	<div class="con ">
	 		<form id="preparedFundDetailForm" action="preparedFundRealTimeDetailQuery" method="post">
	 			<div class="table fontcolor4 fontsize1 fontfamily2">
	 				<table width="100%" border="0" cellpadding="0" cellspacing="0">
	 					<tr>
	 						<td align="right">查询日期(起):</td>
	 						<td>
	 	...
	 	<div class="table fontcolor4 fontsize1 fontfamily2">
	 		<div style="overflow:scroll;">
		 		<table width="1800px" border="0" cellpadding="0" cellspacing="0">
		 			...
		 			<c:if test="${empty preparedFundRealTimeDetailList}">
	                    <tr>
	                        <td class="fontfamily1" colspan="5" align="center">没有相关记录!</td>
	                    </tr>
	                </c:if>
	                <c:forEach var="balance" items="${preparedFundRealTimeDetailList}" varStatus="status">
	 			...
	 			<table width="100%" cellspacing="0" cellpadding="0" height="24">
					<tr>
						<td align="right" height="24">
							<easipay:pageNum pageSize="${pageSize}" count="${totalCount}" pageNo="${pageNo}" url="/preparedFundRealTimeDetailQuery"/>
						</td>
					</tr>
				</table>
	 		</div>
