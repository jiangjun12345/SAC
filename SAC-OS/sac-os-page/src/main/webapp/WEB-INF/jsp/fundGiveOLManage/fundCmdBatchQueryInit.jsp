...
function queryMsg(){
	$("#subForm").attr("action","${ctx}/fundCmdBatchQueryInit").submit();
}
function downloadCmdBatch(){
	
	if (window.confirm("确定下载？")) {
		$("#subForm").attr("action","${ctx}/downloadCmdAndBatchToExcel").submit();
	}
}
...
<!-- Body -->
    ...
    <div class="content">
      ...
      <div class="con ">
				<form:form id="subForm"  action="${ctx}/fundCmdBatchQueryInit" method="POST" >   	    
					<div class="table fontcolor4 fontsize1 fontfamily2">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<td width="25%"><select id="msgReceiver" name="msgReceiver" value="${msgReceiver}" 
									class="select1">
        ...
        <table id = "table1"  width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						value="" onclick="checkboxall('checkall','box')" /></th>
							...
							<table width="100%" cellspacing="0" cellpadding="0" height="24">
									...
									<td align="right" height="24"><easipay:pageNum pageSize="${pageSize}" count="${count}" pageNo="${pageNo}" url="/fundCmdBatchQueryInit"/>
									</td>
								</tr>
							</table>
							</div>
    		...
    		<div >
						<table  align="right">
								...
								<td align="right"><input name="submitbtn" type="button" 
									 value="作废" class="bluebtn"
									id="submitbtn" onclick="cancelBatch();"/>
								</td>
								
								<td align="right"><input name="submitbtn" type="button" 
									 value="确认划款" class="bluebtn"
									id="submitbtn" onclick="transferConfirm();"/>
								</td>
								
								<td align="left"><input name="submitbtn" type="button" 
									 value="下载" class="bluebtn"
									id="submitbtn" onclick="downloadCmdBatch();"/>
								</td>
								</tr>
							</table>
							</div>
