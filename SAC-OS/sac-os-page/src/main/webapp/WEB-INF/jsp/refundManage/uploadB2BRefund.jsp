...
<body>
	...
	<div class="content">
	 	<div class="con ">
			<form id="uploadForm" action="uploadB2BRefundFile" method="post" enctype="multipart/form-data">
				<div class="table fontcolor4 fontsize1 fontfamily2">
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
	 					<div  align="center">
	 					<tr id="otherRecType">
	 						<td align="right"><font size="3">退款批次Excel文件：</font></td>
	 						<td>
