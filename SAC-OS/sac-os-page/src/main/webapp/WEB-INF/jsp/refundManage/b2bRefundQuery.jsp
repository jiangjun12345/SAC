...
<script type="text/javascript">
	$(function(){
		...
		$("#download").click(function(){
			$("#refundTrxForm").attr("action","${ctx}/purchaseAndPayDownload").submit();
			$("#refundTrxForm").attr("action","${ctx}/purchaseAndPayQuery");
		});
	});
...
<body>
	...
	<div class="content">
	 	<div class="con ">
	 		<form id="refundTrxForm" action="b2bRefundQuery" method="post">
	 			...
	 			<table width="100%" cellspacing="0" cellpadding="0" height="24">
					<tr>
						<td align="right" height="24">
							<easipay:pageNum pageSize="${pageSize}" count="${totalCount}" pageNo="${pageNo}" url="/b2bRefundQuery"/>
						</td>
					</tr>
				</table>
	 		</div>
