...
<script type="text/javascript">
	...
	function addConfirmInit() {
		...
		var flag = true;
		var url = "feeOutInitHandle";
		
		var craccBankNodeCode = document.getElementById("craccBankNodeCode").value;
		
		var craccBankNameObj = document.getElementById("craccBankNodeCode");
		var craccBankName = craccBankNameObj.options[craccBankNameObj.options.selectedIndex].text;
			...
			<div  class="table fontcolor4 fontsize1 fontfamily2">
				<table  width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td align="right" colspan="1">结转金额：</td>
						<td>
				...
				<div>
					<table align="center">
						...
						<td align="center" width="100%">
							<input id="Pass" name="Pass" type="button" maxlength="30" class="bluebtn" value="结转" onclick="addConfirmInit();" />
						</td>
						</tr>
					</table>
				</div>
