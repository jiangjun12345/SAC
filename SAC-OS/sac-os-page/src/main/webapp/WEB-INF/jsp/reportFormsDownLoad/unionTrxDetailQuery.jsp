...
<script type="text/javascript">
	$(function(){
		...
		$("#download").click(function(){
			$("#trxDetailForm").attr("action","${ctx}/unionTrxDetailDownload").submit();
			$("#trxDetailForm").attr("action","${ctx}/unionTrxDetailQuery");
		});
	});
...
<title>中金交易明细查询</title>
</head>

<body>
	<div class="content">
	 	<div class="con ">
	 		<form id="trxDetailForm" action="unionTrxDetailQuery" method="post" >
	 			<div class="table fontcolor4 fontsize1 fontfamily2">
	 				<table width="100%" border="0" cellpadding="0" cellspacing="0">
	 					...
	 					<tr>
	 						...
	 						<td align="right"/>
	 						<td><input id="query" class="bluebtn" type="button" value="查询" ></td>
	 					</tr>
	 					<tr>
	 	...
	 	<div class="table fontcolor4 fontsize1 fontfamily2" >
	 		...
	 		<div style="width: 100%; height:auto; text-align: right;"id="pageDiv" class="pagination1 btn">
	 			<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td align="right" >
							<easipay:pageNum pageSize="${pageSize}" count="${totalCount}" pageNo="${pageNo}" url="/unionTrxDetailQuery"/>
						</td>
					</tr>
				</table>
	 		</div>
