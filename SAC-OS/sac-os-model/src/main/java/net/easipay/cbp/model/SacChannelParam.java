...
@Entity
@Table(name = "SAC_CHANNEL_PARAM", schema = "SAC_SYN")
public class SacChannelParam implements java.io.Serializable
{
	...
	public SacChannelParam()
	{
	}

	public SacChannelParam(Long id, String bankNodeCode, String chnName, String sacBankName, String accountName, String bankAcc, String craccBankCode, String currencyType, Integer sacPeriod,
