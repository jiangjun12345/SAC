...
public class SacRecBatch implements java.io.Serializable {
	...
	public SacRecBatch(Long recBatchId, String recType, String recDate,
			String recOper, Long recCount, String recStatus, Date updateTime,
			Date createTime, String memo,String chnCode,String payconType) {
		this.recBatchId = recBatchId;
	...
	/*@Column(name = "REC_DATE", length = 16)
	...
	@Column(name = "PAYCON_TYPE", length = 8)
